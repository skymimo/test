...
* <mark style="color:blue;">키보드도 접근할 수 있도록 개발도 필요하다.</mark>&#x20;
...
> 그래픽 Person using Apple Vision Pro to view content animation <mark style="color:orange;">// video 영상 설명</mark>
>
> 버튼 Pause entertainment animation <mark style="color:orange;">// 일시 정지 버튼</mark>
...
> 그래픽 Person using Apple Vision Pro to view content animation /<mark style="color:orange;">/ video 영상 설명</mark>
>
> Pause entertainment animation 버튼  소리 없이 14초 동안 재생되는 영상 <mark style="color:orange;">// 일시정지 버튼으로 tab키 이동</mark>
