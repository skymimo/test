...
좌석 선택 기능도 모든 브라우저에서 호환이 가능한 Native HTML이나 Role 속성이 없으므로 role="application"을 삽입하고 키보드 운용 방법을 스크린리더 사용자와 키보드 사용자 모두에게 알릴 수 있도록 제공한다.
...
아기바구니를 신청할 수 있는 좌석, 장애인이 앉을 수 있는 좌석, 산소마스크가 부족한 좌석, 창문이 없는 좌석 등등 항공사에서 제공해야 하는 정보는 무수히 많다. ㅠ.ㅠ
