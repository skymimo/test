...
이처럼 aria 속성 몇 개를 활용하면 스크린리더 사용자들도 키보드 사용자들도 몇 번의 키보드 클릭으로 빠르게 원하는 메뉴로 이동이 가능하게 된다. 물론 aria를 쓴다고 키보드 인터랙션이 자동으로 구현되지는 않으므로 스크립트를 통한 개발은 필요하다.
